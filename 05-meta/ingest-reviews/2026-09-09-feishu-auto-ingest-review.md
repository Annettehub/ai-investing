...
|---|---:|---|---|---|---|---|---|
| `03-raw/feishu/2026-09-09 2030FY 预训练进步主要来自数据.md` | 1 | G3 | G3 | `02-kb/hypotheses/G-需求与周期/G3-inference-demand-scale.md` | 内存 | `未创建` | 主路由为 G3 推理需求与规模；交叉命中：G3 推理需求与规模，建议进入 distill 人工复核。 |
